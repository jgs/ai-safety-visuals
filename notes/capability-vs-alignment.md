...
Matching visual: [`capability-vs-alignment-gap.svg`](../visuals/capability-vs-alignment/capability-vs-alignment-gap.svg)
...
This visual is conceptual. It does not plot real capability growth, predict AGI timelines, or claim that alignment progress is numerically slower than capability progress. It shows why evaluation and safeguard work must scale with capability.

## Social Caption

The safety question is not only "how capable is the model?" It is also "can our evaluations, monitoring, safeguards, and governance keep up with what the system can now do?"
